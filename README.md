...
```sh
ansible-galaxy install elastic.beats,v7.17.22
```
...
The above installs Filebeat 7.17.22 on the hosts 'localhost'.
...
- **beats_version** (*Defaults to `7.17.22`*): Beats version.
